...
const OUT_FILE   = resolve(__dirname, 'day3-reel.mp4');
...
console.log('🎬 Day 3 Reel — "Help people discover the toxic boss"');
...
const OUT = resolve(__dirname, 'day3-reel.mp4').replace(/\\/g,'/');
console.log('\n🎞  Encoding MP4...');
